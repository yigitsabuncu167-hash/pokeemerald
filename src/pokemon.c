...
static const u16 sHoennToNationalOrder[NUM_SPECIES - 1] =
{
    ...
    HOENN_TO_NATIONAL(MRMIME),
    HOENN_TO_NATIONAL(JYNX),
    HOENN_TO_NATIONAL(ELECTRABUZZ),
